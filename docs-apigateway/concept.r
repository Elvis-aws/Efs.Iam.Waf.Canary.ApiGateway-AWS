...
***********
    ...
    ****************
        ...
        - For this, you configure the methods integration request and integration response to associate a response
    ...
    *****************
        ...
        - For HTTP proxy integration, API Gateway passes the entire request and response between the frontend and
          an HTTP backend
        ...
        - In REST APIs, proxy integration is most commonly used with a proxy resource, which is represented by a
          greedy path variable (for example, {proxy+}) combined with a catch-all ANY method
    ...
    ***************************
        - You can use API Gateway stage variables to access the HTTP and Lambda backends for different API deployment
          stages
        - You can also use stage variables to pass stage-specific configuration metadata into an HTTP backend
