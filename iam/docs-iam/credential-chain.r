...
*************************
    - All SDKs have a series of places (or sources) that they check in order to find valid credentials to use to
      make a request to an AWS service
    - After valid credentials are found, the search is stopped
    - This systematic search is called the default credential provider chain
